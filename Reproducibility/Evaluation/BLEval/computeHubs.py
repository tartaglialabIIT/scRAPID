...
def Hubs(datasetDict, inputSettings,TFEdges=True):
    '''
    ...
    for the original functions computing all measures of hub similarities.
    ...
    refPR, refIC, refOC, refEIG, refBT, refRD,REFprhubs1,REFprhubs2,REFidhubs1,REFidhubs2,REFodhubs1,REFodhubs2,REFbthubs1,REFbthubs2,REFradhubs1,REFradhubs2 = Hubs_directed(refGraph, refGraph,set(trueEdgesDF.Gene1),set(trueEdgesDF.Gene2))
    ...
    for algo in tqdm(inputSettings.algorithms,
        ...
        if Path(outDir + '/' +algo[0]+'/rankedEdges.csv').exists():
            ...
            if not predDF.shape[0] == 0:
                ...
                #X=[(numNodes,numEdges,mapping) for j in range(50)]
                #results = []
                #n_cores=None
                ...
                #results = pool.starmap_async(RandomJaccard, X)
                #results = results.get()
                #pool.close()
...
#                    r_vals = r_vals+1/300*np.array(Hubs_undirected(rGr,refGraph)[:6])
#                    rd_vals = rd_vals+1/300*np.array(Hubs_directed(rGrd,refGraph)[:6])
                ...
                if algo[0] == 'PPCOR' or algo[0] == 'PIDC':
                    dataDict['PR'][algo[0]], dataDict['IC'][algo[0]], dataDict['OC'][algo[0]], dataDict['EIG'][algo[0]], dataDict['BT'][algo[0]], dataDict['RD'][algo[0]],hubsDict['PR'][algo[0]],a, hubsDict['IC'][algo[0]],b, hubsDict['OC'][algo[0]],c, hubsDict['BT'][algo[0]],d, hubsDict['RD'][algo[0]],e = Hubs_undirected(predGraph,refGraph,set(trueEdgesDF.Gene1),set(trueEdgesDF.Gene2))
                else:
                    dataDict['PR'][algo[0]], dataDict['IC'][algo[0]], dataDict['OC'][algo[0]], dataDict['EIG'][algo[0]], dataDict['BT'][algo[0]], dataDict['RD'][algo[0]],hubsDict['PR'][algo[0]],a, hubsDict['IC'][algo[0]],b, hubsDict['OC'][algo[0]],c, hubsDict['BT'][algo[0]],d, hubsDict['RD'][algo[0]],e = Hubs_directed(predGraph,refGraph,set(trueEdgesDF.Gene1),set(trueEdgesDF.Gene2))
            else:
